        ...
        <div class="col-md-12">
            <table class="table  w-auto" width="100%">
                ...
                @foreach(App\Models\Blog::Paginate(15) as $blog)
                    <tr>
                        <td>{{$blog->id}}</td>
                        <td><img src="/assets/{{$blog->thumb}}" alt="{{$blog->title}}" width="32px" class="img img-thumbnail"></td>
                        <td>{{$blog->title}}</td>
...
@endsection
@section('scripts')
    <script src="/assets///cdn.ckeditor.com/4.14.1/standard/ckeditor.js"></script>
